...
define(['angular-mocks', 'scripts/apis/apiApp', 'scripts/apis/groups/groupsApiSrv'], function (mock) {

    describe('Api: groupApiSrv', function () {
        var targetSrv,
            configMock = {
                lang: ''
            },
        ...
        beforeEach(mock.inject(function ($rootScope, $controller, $injector, $httpBackend, _$translate_) {
            $q = $injector.get('$q');
            targetSrv = $injector.get('groupsApiSrv');
