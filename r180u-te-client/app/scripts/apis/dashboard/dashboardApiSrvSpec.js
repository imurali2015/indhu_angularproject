...
define(['angular-mocks', 'scripts/apis/apiApp', 'scripts/apis/dashboard/dashboardApiSrv'], function (mock) {

    describe('Api: dashboardApiSrv', function () {
        var targetSrv,
            configMock = {
                lang: ''
            },
        ...
        beforeEach(mock.inject(function ($rootScope, $controller, $injector, $httpBackend, _$translate_) {
            $q = $injector.get('$q');
            targetSrv = $injector.get('dashboardApiSrv');
