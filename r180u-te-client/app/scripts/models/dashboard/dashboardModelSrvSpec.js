...
define(['angular-mocks', 'scripts/models/modelsApp', 'scripts/models/dashboard/dashboardModelSrv'], function (mock) {

    describe('Model: dashboardModelSrv', function () {
        var targetSrv,
            configMock = {
                lang: ''
            },
        ...
        beforeEach(mock.inject(function ($rootScope, $controller, $injector, $httpBackend, _$translate_) {
            $q = $injector.get('$q');
            targetSrv = $injector.get('dashboardModelSrv');
