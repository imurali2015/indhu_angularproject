...
angular.module('ct.ui.router.extras').provider('$futureState',
    [ '$stateProvider', '$urlRouterProvider',
        function _futureStateProvider($stateProvider, $urlRouterProvider) {
            ...
            var transitionPending = false, resolveFunctions = [], initPromise, initDone = false, promiseInit = false;
            var provider = this;
            ...
            function lazyLoadState($injector, futureStates) {
                ...
                if (!factory) throw Error("No state factory for futureState.type: " + (futureStates && futureState[0].type));
